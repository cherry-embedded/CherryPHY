...
void yt8522_phy_init(uint8_t busid, uint16_t phy_addr, struct chry_phy_config *config)
{
}

void yt8522_phy_get_status(uint8_t busid, uint16_t phy_addr, struct chry_phy_status *status)
{
    uint16_t regval;

    regval = chry_mdio_read(busid, phy_addr, YT8522_PHYSTS);
...
const struct chry_phy_driver yt8522_driver = {
    ...
    .phy_name = "YT8512/YT8522",
    .phy_desc = "MOTOR COMM YT8512/YT8522 Ethernet PHY",
